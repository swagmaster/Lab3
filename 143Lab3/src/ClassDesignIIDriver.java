...
public class ClassDesignIIDriver {
    ...
    public static void main(String[] args) {
        ...
        math2Driver();
        //passByReferenceDemo();
        //Note: you will not use moneyDriver the Lab 3 assignment
        //moneyDriver();
    }
    ...
    public static void passByReferenceDemo() {
        ...
        System.out.println("b is :" + b);
        /*
         * 1. When you pass a primitive, you are passing in a copy of that value.
         * 	  When you pass in an object, you pass in the memory address to the method.
         * 2. No the scope of that primitive does not change because you can't pass by 
         *    reference.
         * 3. However, the object is able to change scope.
         * 4. THe scope of the object is to that class the object was created from.
         */
